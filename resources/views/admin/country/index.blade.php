                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.country.add') }}" class="btn btn-primary btn-flat float-right">Add
                                    Country</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
    ...
    <script>
        $(function() {
            ...
            initaltable.DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.get-country-list') }}",
                    type: "POST",
        ...
        $(document).on('click', '.delete_counntry', function() {
            var id = $(this).data('id');
                        ...
                        success: function(data) {
                            ...
                            if(result.status == 1){
                                $(document).Toasts('create', {
                                    ...
                                    body: 'Country Delete Succefully!.'
                                });
