                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.subject.add') }}" class="btn btn-primary btn-flat float-right">Add
                                    Subject</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
    ...
    <script>
        $(function() {
            ...
            initaltable.DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.get-subject-list') }}",
                    type: "POST",
                    data: function(d) {
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#subject_table').DataTable().draw();
                            $(document).Toasts('create', {
                                class: 'bg-success',
                                title: 'Delete',
                                subtitle: 'Subject Delete',
                                body: 'Subject Delete Succefully!.'
                            });
