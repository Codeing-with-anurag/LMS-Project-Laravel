                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.test.add') }}" class="btn btn-primary btn-flat float-right">Add
                                    Test</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#test_table').DataTable().draw();
                            $(document).Toasts('create', {
                                class: 'bg-success',
                                title: 'Delete',
                                subtitle: 'Test Delete',
                                body: 'Test Delete Succefully!.'
                            });
