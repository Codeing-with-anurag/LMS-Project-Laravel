        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="banner-content">
                    <h1 class="title" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">Get <span class="color-secondary">2500+</span> <br>Best Online Courses From {{ env("APP_NAME")}}</h1>
            ...
            <div class="col-lg-6">
                <div class="banner-thumbnail">
                    <div class="thumbnail" data-sal-delay="500" data-sal="slide-left" data-sal-duration="1000">
                        <img src="{{asset('front/images/mainimage.jpg')}}" alt="Girl Image">
                    </div>
                    
                    <ul class="shape-group">
                        <li class="shape-1" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                            <img data-depth="1.5" src="{{asset('front/images/about/shape-15.png')}}" alt="Shape">
                        </li>
                        <li class="shape-2 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                            <img data-depth="-1.5" src="{{asset('front/images/about/shape-16.png')}}" alt="Shape">
                        </li>
                        ...
                        <li class="shape-4" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                            <img data-depth="-1" src="{{asset('front/images/counterup/shape-02.png')}}" alt="Shape">
                        </li>
                        ...
                        <li class="shape-6 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                            <img data-depth="-2" src="{{asset('front/images/about/shape-18.png')}}" alt="Shape">
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        <div class="features-grid-wrap">
            <div class="features-box features-style-2 edublink-svg-animate">
                <div class="icon">
                    <img class="svgInject" src="{{asset('front/images/animated-svg-icons/online-class.svg')}}" alt="animated icon">
                </div>
                <div class="content">
            ...
            <div class="features-box features-style-2 edublink-svg-animate">
                <div class="icon">
                    <img class="svgInject" src="{{asset('front/images/animated-svg-icons/instructor.svg')}}" alt="animated icon">
                </div>
                <div class="content">
            ...
            <div class="features-box features-style-2 edublink-svg-animate">
                <div class="icon certificate">
                    <img class="svgInject" src="{{asset('front/images/animated-svg-icons/certificate.svg')}}" alt="animated icon">
                </div>
                <div class="content">
            ...
            <div class="features-box features-style-2 edublink-svg-animate">
                <div class="icon">
                    <img class="svgInject" src="{{asset('front/images/animated-svg-icons/user.svg')}}" alt="animated icon">
                </div>
                <div class="content">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                <div class="about-image-gallery">
                    <img class="main-img-1" src="{{asset('front/images/learnandgrow.jpg')}}" alt="About Image">
                    ...
                    <ul class="shape-group">
                        ...
                        <li class="shape-2 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                            <img data-depth="-1" src="{{asset('front/images/about/shape-37.png')}}" alt="Shape">
                        </li>
                    ...
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details.html">
                                <img src="{{asset('front/images/course/course-07.jpg')}}" alt="Course Meta">
                            </a>
                            <div class="time-top">
            ...
            <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details.html">
                                <img src="{{asset('front/images/course/course-04.jpg')}}" alt="Course Meta">
                            </a>
                            <div class="time-top">
            ...
            <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details.html">
                                <img src="{{asset('front/images/course/course-05.jpg')}}" alt="Course Meta">
                            </a>
                            <div class="time-top">
            ...
            <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details.html">
                                <img src="{{asset('front/images/course/course-06.jpg')}}" alt="Course Meta">
                            </a>
                            <div class="time-top">
            ...
            <div class="col-lg-8">
                <div class="counterup-box-wrap">
                    ...
                    <ul class="shape-group">
                        ...
                        <li class="shape-2">
                            <img class="rotateit" src="{{asset('front/images/counterup/shape-02.png')}}" alt="Shape">
                        </li>
                        <li class="shape-3 scene">
                            <img data-depth="1.6" src="{{asset('front/images/counterup/shape-04.png')}}" alt="Shape">
                        </li>
                        <li class="shape-4 scene">
                            <img data-depth="-1.6" src="{{asset('front/images/counterup/shape-05.png')}}" alt="Shape">
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-7">
                <div class="brand-grid-wrap">
                    <div class="brand-grid">
                        <img src="{{asset('front/images/brand/brand-01.png')}}" alt="Brand Logo">
                    </div>
                    <div class="brand-grid">
                        <img src="{{asset('front/images/brand/brand-02.png')}}" alt="Brand Logo">
                    </div>
                    <div class="brand-grid">
                        <img src="{{asset('front/images/brand/brand-03.png')}}" alt="Brand Logo">
                    </div>
                    <div class="brand-grid">
                        <img src="{{asset('front/images/brand/brand-04.png')}}" alt="Brand Logo">
                    </div>
                    <div class="brand-grid">
                        <img src="{{asset('front/images/brand/brand-05.png')}}" alt="Brand Logo">
                    </div>
                    <div class="brand-grid">
                        <img src="{{asset('front/images/brand/brand-06.png')}}" alt="Brand Logo">
                    </div>
                    <div class="brand-grid">
                        <img src="{{asset('front/images/brand/brand-07.png')}}" alt="Brand Logo">
                    </div>
                    <div class="brand-grid">
                        <img src="{{asset('front/images/brand/brand-08.png')}}" alt="Brand Logo">
                    </div>
                </div>
            </div>
        </div>
