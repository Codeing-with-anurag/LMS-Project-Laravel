        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <div class="page-title">
                    <h1 class="Dashboard"><i class="fa fa-dashboard"></i>Profile</h1>
                </div>
                                    ...
                                    <div class="inner">
                                        <div class="content">                                            
                                            <ul class="course-item">
                                                <li>
                                                    <span class="label"><i class="icon-60"></i>Email</span>
                                                    <span>{{ auth()->user()->email }}</span>
                                                    
                                                </li>
                                                <li>
                                                    <span class="label"><i class="icon-70"></i>Total Exam:</span>
                                                    <span class="value">3</span>
                                                </li>
                                                <li>
                                                    <span class="label"><i class="icon-68"></i>Passed Exam:</span>
                                                    <span class="value">2</span>
                                                </li>
                                            </ul>
                                            <div class="read-more-btn">
                                                <a href="{{ route('front.logout') }}" class="edu-btn">Logout<i class="icon-4"></i></a>
                                            </div>
